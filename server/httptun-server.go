...
var port = flag.String("p", ":80", "http bind port")
var target = flag.String("t", "127.0.0.1:9999", "real server")
...
var crtFile    = flag.String("ca.crt", "", "PEM encoded certificate file")
var keyFile    = flag.String("ca.key", "", "PEM encoded private key file")
...
func main() {
	...
	http.HandleFunc("/", func (w http.ResponseWriter, req *http.Request) {
		//log.Printf("Redirect")
		//log.Printf("Хост: %v", req.Host)
		//log.Printf("УРЛ: %v", req.URL.String())
		http.Redirect(w, req,
	...
	http.Handle("/tunnel", websrv) // now add to http.DefaultServeMux
...
func startServer(srv *http.Server) {
	...
	if err != nil /*http.ErrServerClosed*/ {
